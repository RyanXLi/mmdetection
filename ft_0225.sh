...
sleep 60
CUDA_VISIBLE_DEVICES=4,5,6,7 bash ./tools/dist_train.sh configs/pascal_voc/scratch_4card.py 4
sleep 60
CUDA_VISIBLE_DEVICES=4,5,6,7 bash ./tools/dist_train.sh configs/pascal_voc/scratch_4card_0.05.py 4
sleep 60
